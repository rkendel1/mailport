...
COPY --from=build /opt/mailport/packages/sdk/package.json ./node_modules/@mailerport/sdk/package.json
COPY --from=build /opt/mailport/packages/sdk/dist ./node_modules/@mailerport/sdk/dist
